<template>
  <div class="add-wrapper">
    ...
    <el-form ref="sellerForm" :model="sellerForm" status-icon label-width="100px" class="seller-table" :rules="rules">
      ...
      <el-form-item>
        <el-button type="primary" @click="addSeller">Add Seller</el-button>
